@echo off
title Claude Code - Public Setup
REM =============================================================================
REM Claude Code - Public Setup
REM
...
REM ---------------------------------------------------------------------------
REM Step 0: Connectivity check (catch network issues before anything else)
REM ---------------------------------------------------------------------------
...
if !ERRORLEVEL! equ 0 (
    ...
    echo     2. Can you reach https://github.com?
    echo.
...
echo.
echo   If Windows asks for an admin password, enter your
echo   computer's administrator password.
echo.
...
REM Check if Rancher was installed under a different user profile
set "RD_OTHER_USER="
...
if "!S_CLONE!"=="1" if exist "!INSTALL_DIR!\seal_install.bat" goto :ccdw_update
if exist "!INSTALL_DIR!\seal_install.bat" goto :ccdw_update

REM --- Check if we can reach the repo (tests both network + auth) ---
echo [...]  Checking GitHub access...
git ls-remote --exit-code https://github.com/sealmindset/CCDW.git HEAD >nul 2>nul
...
git clone https://github.com/sealmindset/CCDW.git "!INSTALL_DIR!"
...
echo.
echo   2. Check your internet connection -- Make sure you
echo      can reach https://github.com in your browser.
echo.
echo   3. Verify you can access github.com -- Open your
echo      browser and visit:
echo        https://github.com/sealmindset/CCDW
echo      If you see "404" or "Page not found", you may
echo      need to request access to the repository.
echo.
...
cd /d "!INSTALL_DIR!"
call "!INSTALL_DIR!\seal_install.bat"
goto :eof
